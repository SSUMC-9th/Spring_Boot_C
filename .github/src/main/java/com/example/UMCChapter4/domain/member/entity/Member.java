...
import com.example.UMCChapter4.domain.member.entity.mapping.MemberMission;
...
import com.example.UMCChapter4.domain.member.enums.SocialType;
...
public class Member extends BaseEntity {
    ...
    @Column(name = "social_uid", length = 30, nullable = false)
